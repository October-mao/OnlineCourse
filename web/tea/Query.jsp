<%@ page language="java" import="java.util.*,com.mao.dao.DaoSc,com.mao.bean.Teacher,com.mao.bean.QueryResult" pageEncoding="utf-8"%>
<%
  ...
  <%
  		...
  		<%
				...
				%> 
						...
						<td><input class="btn" type="button" value="修改教室" onclick="window.location.href=('servlet/serUpdateClass?sno=<%=tem.getSNo()%>&cno=<%=tem.getCNo()%>&type=<%=type%>&key=<%=queryKey%>')"/></td>
						</tr>
