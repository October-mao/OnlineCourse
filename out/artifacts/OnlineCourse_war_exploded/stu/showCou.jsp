<%@ page language="java" import="java.util.*,com.mao.dao.DaoSc,com.mao.bean.Student,com.mao.bean.SedCou" pageEncoding="utf-8"%>
<%
		...
		<div class="box">
			...
			<div class="form">
				<table>
  					...
  					<td><input class="cancle" type="button" value="取消" onClick="window.location.href=('servlet/serDeleteSc?cno=<%= cou.getCNo() %>')"></td>
  					</tr>
		  				<%
		   			}
		   		}
